...
/**
 * Template impor untuk Dokumen Stok Keluar.
 *
 * Kolom:
 * - Product Name / SKU
 * - quantity
 * - unit_cost (opsional, diabaikan untuk OUT)
 * - notes
 */
class StockDocumentsOutImportTemplateExport implements FromArray, WithHeadings, WithEvents, ShouldAutoSize
{
