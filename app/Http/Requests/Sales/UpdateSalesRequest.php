...
/**
 * Validasi input untuk pembaruan transaksi penjualan (POS).
 *
 * Payload mengikuti struktur StoreSalesRequest, namun seluruh field bersifat opsional
 * kecuali metadata utama. Digunakan untuk skenario draft/deposit yang di-update.
 *
 * @author PJD
 */
class UpdateSalesRequest extends BaseApiRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'total_after_discount' => ['nullable', 'integer', 'min:0'],
            ...
            'value_added_tax_amount' => ['nullable', 'integer', 'min:0'],
    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator) {
            ...
            if ($grandTotal > 0 && $grandTotal > $sumPaid && $customerId === '') {
