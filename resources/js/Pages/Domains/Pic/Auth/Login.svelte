...
<div
    class="flex flex-col min-h-screen p-4 bg-gradient-to-br from-blue-50 to-white"
>
    <div class="mb-8 pt-10 text-center">
        ...
        <h2 class="text-3xl font-extrabold text-gray-900">Pickup Point</h2>
        <p class="mt-2 text-sm text-gray-600">
            Silahkan masuk ke akun Petugas Pickup Point
        </p>
    </div>
